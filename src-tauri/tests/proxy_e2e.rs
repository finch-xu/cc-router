...
fn provider_loader_loads_builtin_providers() {
    ...
    let ids: HashMap<String, ()> = providers
        ...
        .map(|k| (k.clone(), ()))
        .collect();
    for expected in ["anthropic", "zhipu", "deepseek", "moonshot", "minimax", "xiaomi", "alibaba", "volcengine", "openrouter", "tencent", "aiberm", "whatai", "ollama", "fireworks", "stepfun", "baidu", "modelscope", "ucloud", "openai_codex"] {
